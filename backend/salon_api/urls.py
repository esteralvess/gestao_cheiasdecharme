...
from .views import (
    LocationViewSet, RevenueByServiceReport, StaffCommissionViewSet, StaffViewSet, ServiceViewSet,
    CustomerViewSet, AppointmentViewSet, StaffShiftViewSet, StaffServiceViewSet, 
    StaffExceptionViewSet, ReferralViewSet, ExpenseViewSet,
    RevenueByStaffReport, RevenueByLocationReport, CurrentUserView, UserViewSet, GroupViewSet, PermissionViewSet
)
